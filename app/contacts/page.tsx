        ...
        <div className="space-y-6 rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
          ...
          <section>
            ...
            <p className="mt-2 whitespace-pre-line text-sm leading-relaxed text-muted-foreground">
              {`WhyBao покупает и доставляет товары из Китая в Россию. В стоимость товара уже включена доставка из Китая в Россию. Дополнительно оплачивается только отправка с нашего склада в Москве до вашего города. Самовывоз пока недоступен.`}
            </p>
          </section>
