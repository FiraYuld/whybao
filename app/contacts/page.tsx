        ...
        <div className="mb-8 flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-6">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="mt-1 text-muted-foreground">
              Байер-сервис для комфортного шоппинга. Свяжитесь с нами по любым вопросам.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6 rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
          ...
          <section>
            ...
            <p className="mt-2 whitespace-pre-line text-sm leading-relaxed text-muted-foreground">
              {`WhyBao – это байер-сервис для комфортного шоппинга и окно в мир небольших китайских брендов, которые не выходят на иностранную аудиторию. На WhyBao мы представляем самые горячие бестселлеры абсолютно разных стилей и бесплатно доставляем их в Россию. Мы выбираем только надёжные бренды, с отзывами и отличным качеством. Наша цель – показать самое лучшее из китайской моды и сделать её доступной.`}
            </p>
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Мы также можем выкупить любой товар с китайских маркетплейсов по индивидуальному запросу.
            </p>
          </section>

          <section>
            <h2 className="font-accent text-lg font-bold">Важно</h2>
            <p className="mt-2 whitespace-pre-line text-sm leading-relaxed text-muted-foreground">
              {`WhyBao НЕ является магазином. Мы выступаем в роли посредников, выкупая товары с китайских маркетплейсов. В нашу зону ответственности входит оформление заказа, выкуп и организация доставки до покупателя. Также мы не несём ответственности за брак или качество товара. Товар приходит к вам в том виде, в котором его отправляет продавец.`}
            </p>
          </section>

          <section>
            <h2 className="font-accent text-lg font-bold">Доставка</h2>
            <p className="mt-2 whitespace-pre-line text-sm leading-relaxed text-muted-foreground">
              {`Доставка по РФ осуществляется с нашего склада в Москве. В отличие от других байеров, наша доставка из Китая до Москвы бесплатная.`}
            </p>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              Доставка до покупателя с момента оплаты заказа занимает от 30 до 60 дней.
            </p>
            <p className="mt-2 whitespace-pre-line text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 className="font-accent text-lg font-bold">Оплата и возврат</h2>
            <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
              На данный момент у нас недоступна оплата на сайте. Реквизиты для оплаты можно получить в{" "}
              <a
                href={TELEGRAM_MANAGER}
                target="_blank"
                rel="noopener noreferrer"
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Запросить дополнительную информацию о товарах, доставке и задать любой вопрос можно в{" "}
              <a
                href={TELEGRAM_MANAGER}
                target="_blank"
                rel="noopener noreferrer"
